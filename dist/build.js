...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      ...
      today: __WEBPACK_IMPORTED_MODULE_0_moment___default()(),
    ...
    daysConstructor() {
      ...
      for (let i = 0; i < 42; i++) {
        ...
        const properties = {
          ...
          active: dayMoment.format('MM-DD-YYYY') === __WEBPACK_IMPORTED_MODULE_0_moment___default()(this.selectedDate).format('MM-DD-YYYY'),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_custom_datepicker__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_custom_datepicker___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue_custom_datepicker__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_color__ = __webpack_require__(127);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'app',
  components: {
    CustomDatepicker: __WEBPACK_IMPORTED_MODULE_1_vue_custom_datepicker___default.a,
    Swatches: __WEBPACK_IMPORTED_MODULE_3_vue_color__["Swatches"]
  },
  data() {
    return {
      ...
      selectedDate: __WEBPACK_IMPORTED_MODULE_2_moment___default()(),
  ...
  computed: {
    ...
    formattedDate() {
      return __WEBPACK_IMPORTED_MODULE_2_moment___default()(this.selectedDate).format(this.dateFormat);
    },
    wrapperStyles() {
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__App_vue__ = __webpack_require__(120);
...
// module
exports.push([module.i, ".cd-days>article,.cd-days button,.cd-weekdays>article,.cd-weekdays button{flex-basis:14.28571%;flex-grow:1;display:inline-block;text-align:center;cursor:pointer;height:40px;padding:0;line-height:40px;vertical-align:middle;transition:all .45s cubic-bezier(.23,1,.32,1) 0ms;position:relative}.cd-wrapper{width:350px;display:block;margin:auto;font-family:inherit}.cd-body-wrapper{overflow:hidden;border-radius:2px}.cd-weekdays{text-transform:uppercase;font-size:.9em;font-weight:700;padding:5px 15px;display:flex;flex-wrap:wrap}.cd-weekdays>article{cursor:default}header{text-transform:uppercase;letter-spacing:2px;padding:1em;text-align:center;position:relative}header>button{position:absolute;top:50%;transform:translateY(-50%);cursor:pointer;margin:0;height:25px;width:25px}header>button:first-child{left:25px}header>button:last-child{right:25px}header>article>span:first-child{font-weight:700}.cd-days{padding:5px 15px;display:flex;flex-wrap:wrap;font-size:.8em}.cd-days>button>span{position:relative;z-index:10}.cd-days>button>figure{transition:transform .3s cubic-bezier(.6,.18,.42,1.25) 10ms,opacity 50ms cubic-bezier(.23,1,.32,1);display:block;margin:auto;width:35px;height:35px;background:#ff5a5f;border-radius:100%;border:none;position:absolute;top:50%;left:47.5%;transform:translate3d(-50%,-50%,0) scale(.4);opacity:0}.cd-days>button.disabled{opacity:.4;cursor:default}.cd-days>button.active{color:#fff}.cd-days>button.active>figure{background:#ff5a5f;transform:translate3d(-50%,-50%,0) scale(1);opacity:1}.cd-days>button:hover:not(.active):not(.disabled){color:#fff}.cd-days>button:hover:not(.active):not(.disabled)>figure{transform:translate3d(-50%,-50%,0) scale(1);opacity:.6}.cd-days>button.today:not(.active){color:#ff5a5f}.chevron:before{border-style:solid;border-width:.05em .05em 0 0;content:\"\";display:inline-block;height:.5em;width:.5em;left:0;position:relative;top:0;transform:rotate(-45deg);vertical-align:top}.chevron.right:before{transform:rotate(45deg)}.chevron.bottom:before{transform:rotate(135deg)}.chevron.left:before{transform:rotate(-135deg)}button{box-sizing:content-box;cursor:default;display:inline-block;text-align:center;text-decoration:none;white-space:pre;background:none;border:0;color:inherit;font:inherit;line-height:normal;overflow:visible;padding:0}button:active{outline:none}button:active>figure:after{animation:pulse .5s ease-in-out forwards}button:focus{outline:none}button:focus>figure:after{animation:pulse .5s ease-in-out forwards}button>figure{position:relative;display:flex;align-items:center;justify-content:center;width:100%;height:100%;border-radius:100%}button>figure:after{background:rgba(0,0,0,.15);content:\"\";width:100%;height:100%;display:block;border-radius:inherit;position:absolute;top:0;left:0;z-index:1;visibility:hidden}figure{margin:0}footer button{position:relative;cursor:pointer}footer figure{position:absolute;top:0;left:0;width:50px;height:50px}footer figure .st0{fill:none;stroke:#000;stroke-width:35;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10}footer svg{width:50px;height:50px}footer svg .st0{fill:none;stroke:#000;stroke-width:35;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10}.animate-next{animation:monthChange .4s cubic-bezier(.66,-.01,.69,1.23) normal forwards}.animate-prev{animation:monthChange .4s cubic-bezier(.66,-.01,.69,1.23) reverse forwards}@keyframes pulse{0%{visibility:visible;opacity:1;transform:scaleX(1)}to{visibility:visible;opacity:0;transform:scale3d(1.4,1.4,1)}}@keyframes monthChange{0%{opacity:1;transform:translateZ(0)}40%{opacity:0;transform:translate3d(30%,0,0)}60%{opacity:0;transform:translate3d(-30%,0,0)}to{opacity:1;transform:translateZ(0)}}", ""]);
...
// module
exports.push([module.i, "#app,body,html{box-sizing:border-box;margin:0;padding:0}#app{font-family:Cabin,monospace;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-align:center;color:#2c3e50;width:100%;height:100%;display:flex;align-items:center}#app h1{color:#fff;letter-spacing:2px;font-weight:400;font-size:2.5em;opacity:.8}#app h1:after{content:\"\";height:5px;background:#fff;width:20%;display:block;margin:auto;position:relative;top:20px}#app>section{flex-basis:50%}#app>section:last-child{position:relative}#app>section:last-child h2{margin-top:0;position:absolute;top:-100px;left:50%;transform:translateX(-50%)}.style-selector{min-height:100vh;box-shadow:0 10px 30px rgba(0,0,0,.188235),0 6px 10px rgba(0,0,0,.227451);font-family:Titillium Web,sans-serif;color:#fff;font-size:1.1em;transition:all .4s ease-in-out}.style-selector>pre{display:flex;flex-wrap:wrap;margin-top:50px}.style-selector>pre>div{flex-basis:100%;margin:-15px auto;text-align:left;position:relative}input,textarea{background:rgba(0,0,0,.12);border:none;outline:none;padding:5px 10px;margin:10px 25px;color:#fff;font-family:monospace;white-space:pre;font-size:1em;max-width:100%;width:300px}input+span,textarea+span{position:relative;top:7.5px;left:-15px}.limits input{width:345px}textarea{width:412.5px;height:50px}.color-input{cursor:pointer}.vue-color__swatches{position:absolute;z-index:100;height:285px;left:25%;border-radius:2px}", ""]);
...
"use strict";
/* unused harmony export shadeColor */
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "click": function($event) {
        _vm.incrementMonth($event, -1)
      }
    }
  })]), _vm._v(" "), _c('article', {
    attrs: {
      "data-transition": "month-change"
    }
  }, [_c('span', [_vm._v(_vm._s(_vm.displayDate.format('MMMM')))]), _vm._v(" "), _c('span', [_vm._v(_vm._s(_vm.displayDate.format('Y')))])]), _vm._v(" "), _c('button', [_c('figure', {
    ...
    staticClass: "cd-weekdays",
    style: (_vm.weekdayStyles),
    attrs: {
      "id": "cd-day-select"
    }
  }, _vm._l((_vm.weekdayLabels), function(weekday) {
  ...
  }, _vm._l((_vm.daysConstructor), function(day, i) {
    return _c('button', {
      key: i,
      class: {
        disabled: day.disabled, active: day.active
      },
      style: (_vm.dayStyle(day)),
      on: {
        "click": function($event) {
          _vm.selectDate($event, day)
        }
      }
    }, [_c('span', [_vm._v(_vm._s(day.format('D')))]), _vm._v(" "), _c('figure', {
      style: ({
        background: _vm.activeDateBackgroundColor || _vm.primaryColor
      })
    })])
  }))])])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "click": _vm.closeColorSelector
    }
  }, [_c('section', {
    staticClass: "style-selector",
    style: (_vm.formStyles)
  }, [_c('h1', [_vm._v("Vue Custom Datepicker")]), _vm._v(" "), _c('pre', [_vm._v("\n      "), _c('div', [_vm._v("\n        "), _c('label', [_vm._v("primaryColor:")]), _c('input', {
    staticClass: "color-input",
    attrs: {
      "readonly": ""
    },
    domProps: {
      "value": _vm.calPrimaryColor
    },
    on: {
      "click": function($event) {
        $event.stopPropagation();
        _vm.showColorSelector($event)
      }
    }
  }), _c('span', [_vm._v(",")]), (_vm.colorSelectorOpen) ? _c('Swatches', {
    on: {
      "change-color": _vm.changeColor
    },
    model: {
  ...
  }) : _vm._e(), _vm._v("\n        "), _c('label', [_vm._v("dateFormat:  ")]), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    on: {
      "input": function($event) {
        ...
        _vm.dateFormat = $event.target.value
      }
    }
  }), _c('span', [_vm._v(",")]), _vm._v("\n      ")], 1), _vm._v("\n      "), _c('div', [_vm._v("\n        "), _c('label', [_vm._v("wrapperStyles: {")]), _vm._v("\n        "), _c('textarea', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.wrapperStylesString),
      expression: "wrapperStylesString"
    }],
    attrs: {
      "type": "text"
    },
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.wrapperStylesString = $event.target.value
      }
    }
  }), _vm._v("\n        "), _c('label', [_vm._v("},")]), _vm._v("\n      ")]), _vm._v("\n      "), _c('div', [_vm._v("\n        "), _c('label', [_vm._v("headerStyles: {")]), _vm._v("\n        "), _c('textarea', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.headerStylesString),
      expression: "headerStylesString"
    }],
    attrs: {
      "type": "text"
    },
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.headerStylesString = $event.target.value
      }
    }
  }), _vm._v("\n        "), _c('label', [_vm._v("},")]), _vm._v("\n      ")]), _vm._v("\n      "), _c('div', [_vm._v("\n        "), _c('label', [_vm._v("weekdayStyles: {")]), _vm._v("\n        "), _c('textarea', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.weekdayStylesString),
      expression: "weekdayStylesString"
    }],
    attrs: {
      "type": "text"
    },
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.weekdayStylesString = $event.target.value
      }
    }
  }), _vm._v("\n        "), _c('label', [_vm._v("},")]), _vm._v("\n      ")]), _vm._v("\n      "), _c('div', {
    staticClass: "limits"
  }, [_vm._v("\n        "), _c('label', [_vm._v("limits: {")]), _vm._v("\n          "), _c('label', [_vm._v("start:")]), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.limitsStart),
      expression: "limitsStart"
    }],
    attrs: {
      "type": "text"
    },
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.limitsStart = $event.target.value
      }
    }
  }), _c('span', [_vm._v(",")]), _vm._v("\n          "), _c('label', [_vm._v("end:  ")]), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.limitsEnd),
      expression: "limitsEnd"
    }],
    attrs: {
      "type": "text"
    },
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.limitsEnd = $event.target.value
      }
    }
  }), _vm._v("\n        "), _c('label', [_vm._v("}")]), _vm._v("\n      ")]), _vm._v("\n    ")])]), _vm._v(" "), _c('section', [_c('div', {
    staticClass: "calendar"
  }, [_c('h2', [_vm._v(_vm._s(_vm.formattedDate))]), _vm._v(" "), _c('CustomDatepicker', {
    attrs: {
      "date": _vm.selectedDate,
      "primaryColor": _vm.calPrimaryColor,
      "dateFormat": _vm.dateFormat,
      "wrapperStyles": _vm.wrapperStyles,
      "headerStyles": _vm.headerStyles,
      "weekdayStyles": _vm.weekdayStyles,
      "limits": _vm.limits
    },
    on: {
...
var update = __webpack_require__(119)("57dbca2b", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(119)("3c23871a", content, true);
